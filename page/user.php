                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a onclick="swalDelete('proses/pelanggan.php?aksi=delete&id_user=<?php echo $d['id_user'] ?>')" class="badge bg-danger float-end"><i class="fa fa-times" aria-hidden="true"></i></a>
                                <button
                                  type="button"
                                  class="badge border-0 bg-primary float-end mx-2"
                                  data-bs-toggle="modal"
                                  data-bs-target="#edit<?php echo $d['id_user'] ?>"
                                >
                                  Edit
                                </button>
                            </td>
...
>
    ...
    <div class="modal-content">
        ...
        <form action="proses/user.php?aksi=simpan" method="post">
             <?php 
                include 'auth/koneksi.php';
  ...
  >
    ...
    >
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="proses/user.php?aksi=update" method="post">
            <div class="form-group position-relative has-icon-left mb-4">
              <input
                type="text"
                class="form-control"
